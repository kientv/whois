...
<head>
  ...
  <style type="text/css">
    *,body {
    ...
    .logo {
      background-image: url('http://www.avishek.asia/seo-blog/wp-content/uploads/2018/06/Perfect-Domain-Name.png');
...
<body>
  <header>
    <h1 class="logo">Kiểm tra tên miền</h1>
  </header>
            ...
            <div class="card-body row no-gutters align-items-center">
                ...
                <div class="col">
                    <input class="form-control form-control-lg form-control-borderless"
                        type="search"
                        placeholder="Nhập tên miền muốn kiểm tra."
                        name="domain" value="{{.domain}}">
                </div>
                <!--end of col-->
                <div class="col-auto">
                    <button class="btn btn-lg btn-success" type="submit">Kiểm tra</button>
                </div>
                <!--end of col-->
            </div>
        </form>
        <div class="panel panel-primary">
            <div class="panel-body">
                ...
                <div class="alert alert-success">
                    Tên miền: <b>{{.result.Registrar.DomainName}}</b><br />
                    Trạng thái: <b>{{.result.Registrar.DomainStatus}}</b><br />
                    Đăng ký tại: <b>{{.result.Registrar.RegistrarName}}</b><br />
                    Ngày đăng ký: <b>{{.result.Registrar.CreatedDate}}</b><br />
                    Ngày hết hạn: <b>{{.result.Registrar.ExpirationDate}}</b>
                </div>
            </div>
        </div>
    </div>
